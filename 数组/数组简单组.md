...
* 题外话：在写这道题前先插一道题作为引子吧，因为也是常见的面试题我感觉，可能比这道题还常考一些，题目很简单，就八个字，「合并两个递增数组」，也就是说没有「合并 `nums2` 到 `nums1` 中的限制」
...
* 第三种：从后向前三指针
  ...
  * 这种是借鉴来的，以大安老师的为代表，又引申到使用 `&&` 和 `||` 两种思路
  * 从后向前的第一种三指针可以用 && 
    * 时间复杂度超过 88.34% 提交，空间复杂度超过 65.78% 提交
